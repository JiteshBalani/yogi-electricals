...
const Services = () => {
    return (
        <div className='mx-auto max-w-screen-xl md:px-6 lg:px-6 py-3 bg-black text-white mb-5'>
            ...
            <div className='p-10 flex flex-wrap space-y-10'>
                <div className='bg-white bg-opacity-10 p-5 rounded-xl  '>
                    <h2 className='text-lg md:text-xl lg:text-2xl font-semibold bg-gray-400 text-black mb-5 px-2 py-2 md:text-left lg:text-left w-full'>Residential Projects</h2>
                ...
                <div className='bg-white bg-opacity-10 p-5 rounded-xl '>
                    <h2 className='text-lg md:text-xl lg:text-2xl font-semibold md:text-right lg:text-right bg-gray-400 text-black mb-5 px-2 py-2'>Commercial Projects</h2>
                    <div className='md:flex lg:flex justify-center md:justify-between lg:justify-between items-center'>
                        <img src="https://upload.wikimedia.org/wikipedia/en/4/42/IL%26FS_-_Bandra_Kurla_Complex%2C_Mumbai.jpg" alt='Commercial Projects' className=' w-48 border-2 mr-5' />
                ...
                <div className='bg-white bg-opacity-10 p-5 rounded-xl '>
                    <h2 className='text-lg md:text-xl lg:text-2xl font-semibold md:text-left lg:text-left bg-gray-400 text-black mb-5 px-2 py-2'>Industrial Projects</h2>
                    <div className='md:flex lg:flex justify-center md:justify-between lg:justify-between items-center'>
                ...
                <div className='bg-white bg-opacity-10 p-5 rounded-xl '>
                    <h2 className='text-lg md:text-xl lg:text-2xl font-semibold md:text-right lg:text-right bg-gray-400 text-black mb-5 px-2 py-2'>Power Transmission & Distribution</h2>
                    <div className='md:flex lg:flex justify-center md:justify-between lg:justify-between items-center'>
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFuHn_w77uIlOQrJQqj-apXtG0mzboH6iB2JzZWoVAUw&s" alt='Power Transmission & Distribution' className=' w-48 border-2 mr-5' />
                ...
                <div className='bg-white bg-opacity-10 p-5 rounded-xl '>
                    <h2 className='text-lg md:text-xl lg:text-2xl font-semibold md:text-left lg:text-left bg-gray-400 text-black mb-5 px-2 py-2'>Solar Panel Installation</h2>
                    <div className='md:flex lg:flex justify-center md:justify-between lg:justify-between items-center'>
